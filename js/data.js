...
const infoList = [
  ...
  },
  {
    name: "C#(ISTP)",
    detail:
      '"C#은 마이크로소프트에서 개발된 객체 지향 프로그래밍 언어로서 \n' +
  ...
  },
  {
    ...
    lecture:
      "자바스크립트 기초 강의 (ES5+): 같이 노트를 작성하며 배워요 (유튜브)",
    negativeLang: "Rust",
  },
  {
    name: "Typescript(ISTJ)",
    detail:
      '"마이크로소프트에서 구현한 JavaScript의 슈퍼셋(Superset) 프로그래밍 언어. 확장자로는 .ts를 사용[1]하며, 컴파일의 결과물로 JavaScript 코드를 출력한다. \n' +
  ...
  },
  {
    name: "Kotlin(ENTJ)",
    detail:
      '"IntelliJ IDEA의 개발사 JetBrains에서 2011년에 공개한 오픈 소스 프로그래밍 언어. JVM 기반의 언어이며, Java와 유사하지만 더 간결한 문법과 다양한 기능을 추가하였다. Java와의 상호 운용이 100% 지원된다. \n' +
  ...
  },
  {
    name: "Python(ENFP)",
    detail:
      '"Phython은 웹 애플리케이션, 소프트웨어 개발, 데이터 과학, 기계 학습(ML)에 널리 사용되는 프로그래밍 언어입니다. \n' +
  ...
  },
  {
    name: "Rust(INFJ)",
    detail:
      '"러스트(영어: Rust)는 모질라 리서치에서 개발한 범용 프로그래밍 언어이다. \n' +
  ...
  },
  {
    name: "Swift(ENTP)",
    detail:
      '"스위프트(영어: Swift)는 애플의 iOS와 macOS를 위한 프로그래밍 언어로 기존의 애플 운영체제용 언어인 오브젝티브-C와 함께 사용할 목적으로 만들어졌다.\n' +
  ...
  },
  {
    name: "R(ESTJ)",
    detail:
      '"R은 통계 계산과 그래픽을 위한 프로그래밍 언어이자 소프트웨어 환경이다. 오픈소스로 쓰여졌으며 무료이다.\n' +
  ...
  },
  {
    name: "Dart(INFP)",
    detail:
      '"google 구글이 javascript 자바스크립트를 대체하기 위해 2011년 개발한 웹프로그래밍 언어이다.\n' +
