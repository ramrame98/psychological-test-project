...
const infoList = [
  {
    name: "C(ISFJ)",
    detail: "언어 소개: C 언어는 1972년 켄 톰슨과 데니스 리치가 유닉스 운영체제를 만들기 위해 고안한 프로그래밍 언어이며 </br>" +
    ...
    book: "책 추천: c언어의 정석",
    lecture: "강의 추천: 29살의 C언어 with 거니 (유튜브)",
    negativeLang: "안 맞는 언어: Swift",
  },
  {
    name: "C++(ESTP)",
    detail: "언어 소개: C++는 AT&T 벨 연구소의 비야네 스트롭스트룹이 C언어 기반으로 1983년 발표하여 발전한 프로그래밍 언어이다. </br>" +
    ...
    book: "책 추천: 윤성우의 열혈 C++ 프로그래밍",
    lecture: "강의 추천: [하루 10분|C++] 누구나 쉽게 배우는 C++ 프로그래밍 입문 (인프런)",
    negativeLang: "안 맞는 언어: Go",
  },
  {
    name: "C#(ISTP)",
    detail: "언어 소개: C#은 마이크로소프트에서 개발된 객체 지향 프로그래밍 언어로서 Java 나 C++와비슷한 면들을 많이 가지고 있다.</br> " +
    ...
    book: "책 추천: C# 교과서",
    lecture: "강의 추천: Do it! C# 프로그래밍 입문 (인프런)",
    negativeLang: "안 맞는 언어: Kotlin",
  },
  {
    name: "Java(INTP)",
    detail: "언어 소개: 썬 마이크로시스템즈에서 1995년에 개발한 객체 지향 프로그래밍 언어. 창시자는 제임스 고슬링이다. </br> " +
    ...
    book: "책 추천: Java의 정석",
    lecture: "강의 추천: [자바의정석-기초편] (유튜브)",
    negativeLang: "안 맞는 언어: Python",
  },
  {
    name: "Javascript(ESFJ)",
    detail: "언어 소개: 자바스크립트(JavaScript)는 객체(object) 기반의 스크립트 언어입니다. </br> +
    ...
    book: "책 소개: Do it! 자바스크립트 입문",
    lecture: "강의 소개: 자바스크립트 기초 강의 (ES5+): 같이 노트를 작성하며 배워요 (유튜브)",
    negativeLang: "안 맞는 언어: Rust",
  },
  {
    name: "Typescript(ISTJ)",
    detail:
      "언어 소개: 마이크로소프트에서 구현한 JavaScript의 슈퍼셋(Superset) 프로그래밍 언어. 확장자로는 .ts를 사용하며, 컴파일의 결과물로 JavaScript 코드를 출력한다. 최종적으로 런타임에서는 이렇게 출력된 JavaScript 코드를 구동시키게 된다. </br>\n" +
    ...
    book: "책 소개: 타입스크립트 프로그래밍",
    lecture: "강의 소개: TypeScript 강좌 (유튜브)",
    negativeLang: "안 맞는 언어: PHP",
  },
  {
    name: "Kotlin(ENTJ)",
    detail:
      "언어 소개: IntelliJ IDEA의 개발사 JetBrains에서 2011년에 공개한 오픈 소스 프로그래밍 언어. JVM 기반의 언어이며, Java와 유사하지만 더 간결한 문법과 다양한 기능을 추가하였다. Java와의 상호 운용이 100% 지원된다. </br>" +
    ...
    book: "책 소개: Kotlin in Action",
    lecture: "강의 소개: 새차원의 코틀린(Kotlin) 강좌 (인프런)",
    negativeLang: "안 맞는 언어: C#",
  },
  {
    name: "Assembly(INTJ)",
    detail: "언어 소개: 기계어는 실제로 컴퓨터의 CPU가 읽어서 실행할 수 있는 0과 1로 이루어진 명령어의 조합이다. </br>"+
      "이러한 각 명령어에 대해 사람이 알아보기 쉬운 니모닉 기호(mnemonic symbol)를 정해 사람이 좀 더 쉽게 컴퓨터의 행동을 제어할 수 있도록 한 것이 어셈블리 언어이다.",
    book: "책 소개: Arm 프로그래밍",
    lecture: "강의 소개: 배은태-어셈블리 언어 (유튜브)",
    negativeLang: "안 맞는 언어: Ruby",
  },
  {
    name: "Go(ENFJ)",
    detail:
      "언어 소개: Go는 2009년 구글에서 일하는 로버트 그리즈머, 롭 파이크, 켄 톰프슨이 개발한 프로그래밍 언어이다. </br>" +
    ...
    book: "책 추천: Tucker의 Go 언어 프로그래밍",
    lecture: "강의 추천: 초절정 Go 언어 강좌 (유튜브)",
    negativeLang: "안 맞는 언어: C++",
  },
  {
    name: "PHP(ISFP)",
    detail:
      "언어 소개: PHP(PHP: Hypertext Preprocessor)는 C언어를 기반으로 만들어진 서버 측에서 실행되는 서버 사이드 스크립트 언어입니다.</br>" +
  ...
  },
  {
    name: "Python(ENFP)",
    detail:
      "언어 소개: Phython은 웹 애플리케이션, 소프트웨어 개발, 데이터 과학, 기계 학습(ML)에 널리 사용되는 프로그래밍 언어입니다.</br>" +
    ...
    book: "Do it! 점프 투 파이썬",
    lecture:
      "문과생도, 비전공자도, 누구나 배울 수 있는 파이썬(Python)! (인프런)",
    negativeLang: "Java",
  },
  {
    name: "Rust(INFJ)",
    detail:
      "언어 소개: 러스트(영어: Rust)는 모질라 리서치에서 개발한 범용 프로그래밍 언어이다. </br>" +
      "안전하고, 병렬적이며, 실용적인 언어로 디자인되었으며, 순수 함수형 프로그래밍, 액터 기반 병렬 프로그래밍, 명령형 프로그래밍, 객체 지향 프로그래밍 스타일을 지원한다.</br>",
    book: "책 소개: 만들면서 배우는 러스트 프로그래밍",
    lecture: "강의 소개: 엄청 쎈 언어! 러스트(Rust) 강의 (유튜브)",
    negativeLang: "안 맞는 언어: Javascript",
  },
  {
    name: "Ruby(ESFP)",
    detail:
      "언어 소개: Ruby는 균형잡힌 언어여머 Ruby를 만든 유키히로 마츠모토(일명 마츠)는 그가 좋아하는 언어인 Perl, Smalltalk, Eiffel, Ada, Lisp를 섞어서 명령형 프로그래밍 언어이자 함수형 언어이다.",
    book: "책 소개: 퍼펙트 루비",
    lecture: "강의 소개: Rails로 쉽고 빠른 웹사이트 만들기(Ruby Coin) (인프런)",
    negativeLang: "안 맞는 언어: Assembly",
  },
  {
    name: "Swift(ENTP)",
    detail:
      "언어 소개: 스위프트(영어: Swift)는 애플의 iOS와 macOS를 위한 프로그래밍 언어로 기존의 애플 운영체제용 언어인 오브젝티브-C와 함께 사용할 목적으로 만들어졌다.</br>" +
    ...
    book: "책 추천: 꼼꼼한 재은 씨의 스위프트 문법편",
    lecture: "강의 추천: 개발하는 정대리 스위프트 기초 문법 (인프런)",
    negativeLang: "안 맞는 언어: C",
  },
  {
    name: "R(ESTJ)",
    detail:
      "언어 소개: R은 통계 계산과 그래픽을 위한 프로그래밍 언어이자 소프트웨어 환경이다. 오픈소스로 쓰여졌으며 무료이다.</br>" +
    ...
    book: "책 추천: R언어 프로그래밍",
    lecture: "강의 추천: R 기초강의 (유튜브)",
    negativeLang: "안 맞는 언어: Dart",
  },
  {
    name: "Dart(INFP)",
    detail:
      "언어 소개: google 구글이 javascript 자바스크립트를 대체하기 위해 2011년 개발한 웹프로그래밍 언어이다.<br>" +
    ...
    book: "책 추천: Do it! 깡샘의 플러터 & 다트 프로그래밍",
    lecture: "강의 추천: [코드팩토리] [입문] Dart 언어 4시간만에 완전정복 (인프런)",
    negativeLang: "안 맞는 언어: R",
  },
];
