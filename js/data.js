...
const infoList = [
  ...
  },
  {
    name: "C++(ESTP)",
    detail:
      "언어 소개: C++는 AT&T 벨 연구소의 비야네 스트롭스트룹이 C언어 기반으로 1983년 발표하여 발전한 프로그래밍 언어이다. </br>" +
    ...
    lecture:
      "강의 추천: [하루 10분|C++] 누구나 쉽게 배우는 C++ 프로그래밍 입문 (인프런)",
    negativeLang: "안 맞는 언어: Go",
  },
  {
    name: "C#(ISTP)",
    detail:
      "언어 소개: C#은 마이크로소프트에서 개발된 객체 지향 프로그래밍 언어로서 Java 나 C++와비슷한 면들을 많이 가지고 있다.</br> " +
  ...
  },
  {
    name: "Java(INTP)",
    detail:
      "언어 소개: 썬 마이크로시스템즈에서 1995년에 개발한 객체 지향 프로그래밍 언어. 창시자는 제임스 고슬링이다. </br> " +
  ...
  },
  {
    name: "Assembly(INTJ)",
    detail:
      "언어 소개: 기계어는 실제로 컴퓨터의 CPU가 읽어서 실행할 수 있는 0과 1로 이루어진 명령어의 조합이다. </br>" +
  ...
  },
  {
    ...
    lecture:
      "강의 추천: [코드팩토리] [입문] Dart 언어 4시간만에 완전정복 (인프런)",
